...
<head>
    ...
    <title>IQ Test with Instructions and Hints</title>
    <!-- Bootstrap CSS -->
...
<img src="images/logo.png" height="75px" width="150px" alt="IQ Logo" align="center">
    <!-- Instruction Box -->
    ...
    <form action="" method="post" id="quizForm">
        ...
        <!-- View Result Button -->
    <div class="text-center mt-4">
        <a href="http://localhost/proskillmind/pr.php" class="btn btn-success" role="button" style="width: 300px;">View Result</a>
    </div>
    </form>
